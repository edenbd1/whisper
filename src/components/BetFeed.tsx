    ...
    >
      ...
      <div className="h-full w-full flex items-center justify-center lg:pl-[72px]">
        ...
        <div className="relative flex items-end gap-3">
          ...
          <div className="relative w-[100vw] h-[100dvh] lg:w-[540px] lg:h-[92vh] lg:rounded-lg overflow-hidden bg-black lg:ring-1 lg:ring-white/[0.08] lg:shadow-[0_0_40px_rgba(255,255,255,0.03)]">
