  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block fixed top-0 left-[48px] right-0 z-30">
        <div className="flex items-end h-[78px] text-[16px]" style={{ paddingLeft: "16vw" }}>
          <span className="text-white font-bold pb-[20px]" style={{ marginRight: 12 }}>For you</span>
          <span className="text-white font-normal pb-[20px]">Following</span>
        </div>
