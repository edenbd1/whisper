...
async function main() {
  ...
  // Deploy WhisperMarket v9 (updated markets)
  console.log("--- Deploying WhisperMarket v9 ---");
  ...
  const markets = [
    { question: "Will Bitcoin hit $100K before July 2026?", category: "Crypto", imageUrl: "https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=800&q=80", endTime: Math.floor(new Date("2026-07-01").getTime() / 1000) },
    { question: "Will the Iran war end before June 2026?", category: "Geopolitics", imageUrl: "https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=800&q=80", endTime: Math.floor(new Date("2026-06-01").getTime() / 1000) },
    { question: "Will Ethereum be flipped by another coin in 2026?", category: "Crypto", imageUrl: "https://images.unsplash.com/photo-1622630998477-20aa696ecb05?w=800&q=80", endTime: Math.floor(new Date("2026-12-31").getTime() / 1000) },
    ...
    { question: "Is Jesus Christ the true Son of God?", category: "Religion", imageUrl: "https://images.unsplash.com/photo-1507692049790-de58290a4334?w=800&q=80", endTime: Math.floor(new Date("2027-01-01").getTime() / 1000) },
  ...
  console.log("WhisperMarket (v9):", marketAddress);
