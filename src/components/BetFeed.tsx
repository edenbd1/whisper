  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block fixed top-0 left-[48px] right-0 z-30">
        <div className="flex items-start text-[16px]" style={{ paddingLeft: "16vw", paddingTop: 20 }}>
        ...
        <div className="h-px bg-white/10" style={{ marginLeft: "16vw", marginRight: "7vw", marginTop: 20 }} />
      </div>
